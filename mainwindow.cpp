...
void MainWindow::wczytajPakietOneClockRegulator(QByteArray &dane){
    ...
    in>>error_n>>val_wyj>>time>>interwal>>run_str;
    if(error_n > 0) packet_number = error_n;
...
void MainWindow::wczytajPakietTwoClockArx(QByteArray &dane){
